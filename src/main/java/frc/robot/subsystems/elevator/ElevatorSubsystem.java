...
public class ElevatorSubsystem extends SubsystemBase {
  ...
  private final SysIdRoutine EsysIdRoutine =
      new SysIdRoutine(
          ...
          new SysIdRoutine.Mechanism(
              (volts) -> ElevatorMotorLeft.setControl(m_voltReq.withOutput(volts.in(Volts))),
              null,
              this));
  ...
  public void moveElevator(double targetRotations) {
    ...
    SmartDashboard.putNumber("Set_elevator", targetRotations); // 在 SmartDashboard 上显示你设置的目标
  }
  ...
  public Command sysIdQuasistatic(SysIdRoutine.Direction direction) {
    return EsysIdRoutine.quasistatic(direction);
  }

  public Command sysIdDynamic(SysIdRoutine.Direction direction) {
    return EsysIdRoutine.dynamic(direction);
  }
